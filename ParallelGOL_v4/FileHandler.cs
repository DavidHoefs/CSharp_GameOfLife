...
namespace GameOfLifeConsole
{
    public class FileHandler
    {
        ...
        public List<Coord> ReadMatrixToCoord(int[][] inputFile, int numCols, int numRows)
        {
            ...
            for (int i = 0; i < inputFile.Length; i++)
            {
                ...
                {
                    output.Add(new Coord(i,j,inputFile[i][j]));
                }
            }
            return output;
        }
        ...
        public void PrintJaggedMatrixToFile(int[][] matrix)
        {
            StreamWriter streamWriter = new StreamWriter(@"C:\Users\David Hoefs\source\repos\GameOfLifeConsole\GameOfLifeConsole\ParallelOutput_1000x1000.dat");
            for (int i = 0; i < matrix.Length; i++)
            {
                for (int j = 0; j < matrix.Length; j++)
                {
        ...
        public int[][] GenerateRandomBoard(int rows, int cols)
        {
